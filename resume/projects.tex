...
\begin{cventries}
  \cvproject
    ...
    {stack: java, kotlin, HTML, CSS, firebase} % stack
    { \quad An android app aimed at improving user experience of open source VLC media player.Helps to stream video/audio files from android phone to pc without hassle and gives complete control over VLC media player of PC in android app with 2.5L downloads in Playstore.} % Project Description
  ...
  \cvproject
    {Superclip}
    {stack: typescript, electron, react js} % stack
